...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="openapi/rock.page.yaml" icon={icon1} header="Rock">
        This is a sample API.
    </ThinTile>
    <ThinTile to="openapi/paper.page.yaml" icon={launchFastIcon} header="Paper">
        Another API.
    </ThinTile>
    <ThinTile to="openapi/scissors.page.yaml" icon={icon3} header="Scissors">
        And another API.
    </ThinTile>
  </FlexSection>
