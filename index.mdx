...
<Jumbotron>
  ...
  <H1>Fast Technical Documentation</H1>
  <H2>Documentation & support integrating Fast Checkout & Login</H2>
...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
      <ThinTile to="developer-portal/fast-api.md" icon={fastblk} header="Fast API">
        You can easily integrate Fast Checkout & Login into any solution or platform using our Fast API offering. 
    </ThinTile>
    <ThinTile to="developer-portal/bigcommerce.md" icon={bigcommerce} header="BigCommerce">
        Learn how to activate and add Fast Checkout to your BigCommerce store. 
    </ThinTile>
    <ThinTile to="developer-portal/woocommerce.md" icon={woocommerce} header="WooCommerce">
