...
<Box my={25}>
  <SectionHeader>
    Dive in to <Emphasis> Fast </Emphasis> resources.
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1} header="BigCommerce">
        Dive into how to activate and add Fast Checkout to your BigCommerce store. 
    </ThinTile>
    <ThinTile to="developer-portal/index.md" icon={launchFastIcon} header="WooCommerce">
        Learn how to add Fast Checkout to your WooCommerce store using our WordPress plugin that adds Fast checkout to WooCommerce automagically! 
    </ThinTile>
    <ThinTile to="contact.mdx" icon={icon3} header="Other Platforms">
        Working with a different eCommerce solution? No problem. You can easily integrate Fast Checkout into any solution or platform using our Direct Integrations offering. 
    </ThinTile>
  </FlexSection>
